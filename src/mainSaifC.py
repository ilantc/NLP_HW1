...
modelBasic.load(modelFileNameBasic)
modelAdvanced = MEMMModel.MEMMModel(verbose,0,0,0,0)
modelAdvanced.load(modelFileNameAdvanced)

lamdas = []
# basic. advanced
lamdas.append([0.5,0.5])
lamdas.append([0.25,0.75])
lamdas.append([0.75,0.25])
lamdas.append([0.1,0.9])
lamdas.append([0.9,0.1])
lamdas.append([0.34,0.66])
lamdas.append([0.66,0.34])


for currLam in lamdas:
    t1 = time.clock()
    viterbi = ViterbiMEMMModel.ViterbiMEMMModel([modelBasic,modelAdvanced],currLam)
