...
t1 = time.clock()
viterbi = ViterbiMEMMModel.ViterbiMEMMModel([modelBasic,modelAdvanced],[0.75,0.25])
...
processResults(allRes,modelBasic.tagSet,"saif_c_" + str(0.75) + "," + str(0.25),writer)
